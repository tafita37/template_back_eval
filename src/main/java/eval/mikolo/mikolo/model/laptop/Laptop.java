...
public class Laptop {
    ...
    throws Exception {
        ...
        try {
            ...
            resultSet=preparedStatement.executeQuery();
            while(resultSet.next()) {
                result=new TransfertLaptop(resultSet.getInt("id_transfert_laptop"), pointVente, this, resultSet.getDouble("quantite_laptop"), resultSet.getDate("date_transfert"), resultSet.getInt("etat_transfert"));
            }
        } catch (Exception e) {
            throw e;
        } finally {
